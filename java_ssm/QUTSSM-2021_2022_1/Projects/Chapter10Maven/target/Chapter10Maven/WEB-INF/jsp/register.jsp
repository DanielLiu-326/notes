...
<body>
	<form action="${pageContext.request.contextPath}/user/register" method="post" name="registForm">
		...
		align="center">
			...
			<tr><td>选择</td><td>兴趣</td></tr>
			<tr><td><input name="favs" value="1" type="checkbox"></td><td>看书</td></tr>
			<tr><td><input name="favs" value="2" type="checkbox"></td><td>看电影</td></tr>
			<tr><td><input name="favs" value="3" type="checkbox"></td><td>打篮球</td></tr>
